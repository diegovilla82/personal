<div class="p-4" x-data="{ openEdit: @entangle('showModalEdit') }" x-on:keydown.escape="openEdit=false">
    <div class="w-full flex items-center">
        <button type="button"
            ...
            x-on:click="openEdit = true" wire:loading.attr='disabled'>
    ...
    <div x-show="openEdit" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
        ...
        <div x-show="openEdit" x-transition:enter="transition ease-out duration-150"
            ...
            x-transition:leave-end="opacity-0  transform translate-y-1/2" x-on:click.away="openEdit = true"
            ...
            <header class="flex justify-between">
                ...
                <button
                    ...
                    aria-label="close" x-on:click='openEdit = false'>
            ...
            <footer
                ...
                <button x-on:click="openEdit = false"
                    class="w-full px-5 py-3 text-sm font-medium leading-5 text-gray-700 transition-colors duration-150 border border-gray-300 rounded-lg dark:text-gray-400 sm:px-4 sm:py-2 sm:w-auto active:bg-transparent hover:border-gray-500 focus:border-gray-500 active:text-gray-500 focus:outline-none focus:shadow-outline-gray">
                    Cancel
                </button>
                <button type='submit' form="UpdateForm-{{ $this->formId }}"
