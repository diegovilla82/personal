<div class="p-4" x-data="{ openDelete: @entangle('showOpenDelete') }" x-on:keydown.escape="openDelete=false">
    ...
    <div x-show="openDelete" x-transition:enter="transition ease-out duration-150"
        ...
        <div x-show="openDelete" x-transition:enter="transition ease-out duration-150"
            ...
            x-on:away="openDelete=true"
            x-on:escape="openDelete=true"
            ...
            <div class="mt-4 mb-6">
                ...
                {{-- <form wire:submit.prevent='delete' class="space-y-4" id="deleteForm-{{ $this->formId }}">
                    ...
                    <p class="text-sm text-gray-700 dark:text-gray-400">
                       Al eliminar la solicitud, no se producira el pedido.
                    </p>
                {{-- </form> --}}
            </div>
            <footer
